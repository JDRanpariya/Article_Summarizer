...
export default function Home() {
  ...
  return (
    <div className="bg-green-50pt-7 block">
      <Head >
      ...
      m-7 mt-8 text-4xl tracking-wider text-center text-black font-sarif ">
          Article Summarizer
        </h1>

        <p className="text-center text-lg px-3 m-2 text-gray-800 font-sarif font-semibold">
          ...
          <div className='flex-col-3'>
            <div>
              ...
              >
                ...
                <button
                  className="focus:outline-none mt-2 text-gray-900 bg-green-400
      w-full py-2 my-2 hover:bg-green-500 font-sans rounded-lg text-xl text-center"
                  type="submit"
                >
              ...
              >
                <textarea
                  className="focus:outline-none shadow-md border-transparent
      focus focus:border-transparent focus:ring-2 focus:ring-green-500 resize-none w-full border-2  mt-2 rounded-md min-h-full h-64 md:h-64 scale-y-100 p-2 text-mono text-base text-black "
                  onChange={(Event) => setContent(Event.target.value)}
                  placeholder="Paste your article content"
                />
                <button
                  className="focus:outline-none
      mt-2 text-grey-900 bg-green-400 w-full py-2 my-2
      hover:bg-green-500 font-sans rounded-lg text-xl text-center"
                  type="submit"
                >
                  Generate Summary
                </button>
            ...
            {mutationError && console.log(mutationError) && <p>Error :( Please try again</p>}
            {mutationscrapeError && console.log(mutationError) && <p>Error :( Please try again</p>}
            ...
            <div className="hidden  md:block md:justify-center md:align-bottom">
              ...
              <div className="grid grid-flow-col mt-4 ">
                ...
                <a href="https://github.com/jdranpariya" target="_blank">
                  <div className="border ml-5 w-auto border-green-500 p-3 text-center rounded-md hover:bg-green-300 shadow-2xl font-sarif font-bold">
                    About Me{" "}
                  </div>
                </a>
                <div className="flex-grow"></div>
          ...
          <div className="">
            <h3 className="text-center font-semibold text-3xl mb-4 pt-4 md:mt-0 text-gray-900 font-sarif">
              Recent Summaries
            </h3>
            <div className="grid grid-rows md:gap-x-4 ">
              {recentarticles.recentArticles.map((article) => (
                ...
                >
                  ...
                  <div className="text-center font-sans mt-3 mb-3 text-gray-900">
                    {article.summary}
                  </div>
                </div>
              ))}
      ...
      w-auto border-green-500 p-3 text-center rounded-md
      hover:bg-green-300 hover:border-transparent shadow-2xl font-sarif font-bold">
                  About Me
                </div>
